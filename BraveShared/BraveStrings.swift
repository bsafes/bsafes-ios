...
extension Strings {
    ...
    public static let Brave_Shield_Defaults = NSLocalizedString("BraveShieldDefaults", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Security Defaults", comment: "Section title for adbblock, tracking protection, HTTPS-E, and cookies")
    ...
    public static let ReadListScreenTitle = NSLocalizedString("ReadListScreenTitle", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Read List", comment: "Title for read list screen")
    public static let ReadLaterMenuItem = NSLocalizedString("AddtoReading List", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Read Later", comment: "Title for Add To ReadLis menu item")
    public static let ReadListMenuItem = NSLocalizedString("ReadingList", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Reading List", comment: "Title for Read List menu item")
...
extension Strings {
    ...
    public static let OBSkipButton = NSLocalizedString("OnboardingSkipButton", bundle: Bundle.braveShared, value: "   ", comment: "Skip button to skip onboarding and start using the app.")
    public static let OBSaveButton = NSLocalizedString("OBSaveButton", bundle: Bundle.braveShared, value: "Continue", comment: "Save button to save current selection")
    ...
    public static let OBSearchEngineTitle = NSLocalizedString("OBSearchEngineTitle", bundle: Bundle.braveShared, value: "Welcome to BSafes", comment: "Title for search engine onboarding screen")
    public static let OBSearchEngineDetail = NSLocalizedString("OBSearchEngineDetail", bundle: Bundle.braveShared, value: "Your Ad Blocking Reading List, with private search engine", comment: "Detail text for search engine onboarding screen")
    public static let OBShieldsTitle = NSLocalizedString("OBShieldsTitle", bundle: Bundle.braveShared, value: "Ad Blocking", comment: "Title for shields onboarding screen")
