...
extension Strings {
    ...
    public static let OBSearchEngineTitle = NSLocalizedString("OBSearchEngineTitle", bundle: Bundle.braveShared, value: "Welcome to BSafes Private ...", comment: "Title for search engine onboarding screen")
