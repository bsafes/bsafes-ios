...
public struct BraveUX {    
    public static let BraveCommunityURL = URL(string: "http://www.imareader.com/BSafesSecretAdBlockVault/support.html")!
    public static let BravePrivacyURL = URL(string: "http://www.imareader.com/BSafesSecretAdBlockVault/privacyPolicy.html")!
    public static let BraveTermsOfUseURL = URL(string: "http://www.imareader.com/BSafesSecretAdBlockVault/termsOfUse.html")!
